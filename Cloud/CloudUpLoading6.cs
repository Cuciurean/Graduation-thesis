...
public class PostNewTrackableRequest6
{
    public string name;
    public float width;
    public string image;
...
public class CloudUpLoading6 : MonoBehaviour
{
    ...
    private string targetName = "P0005"; // must change when upload another Image Target, avoid same as exist Image on cloud
