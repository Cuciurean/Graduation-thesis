...
public class PostNewTrackableRequest1
{
    public string name;
    public float width;
    public string image;
...
public class CloudUpLoading2 : MonoBehaviour
{
    ...
    private string targetName = "P0001"; // must change when upload another Image Target, avoid same as exist Image on cloud
