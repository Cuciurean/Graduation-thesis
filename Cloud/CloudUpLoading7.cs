...
public class PostNewTrackableRequest7
{
    public string name;
    public float width;
    public string image;
...
public class CloudUpLoading7 : MonoBehaviour
{
    ...
    private string targetName = "P0006"; // must change when upload another Image Target, avoid same as exist Image on cloud
