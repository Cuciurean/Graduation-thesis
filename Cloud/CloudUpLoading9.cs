...
public class PostNewTrackableRequest9
{
    public string name;
    public float width;
    public string image;
...
public class CloudUpLoading9 : MonoBehaviour
{
    ...
    private string targetName = "P0008"; // must change when upload another Image Target, avoid same as exist Image on cloud
