...
public class PostNewTrackableRequest4
{
    public string name;
    public float width;
    public string image;
...
public class CloudUpLoading4 : MonoBehaviour
{
    ...
    private string targetName = "P0003"; // must change when upload another Image Target, avoid same as exist Image on cloud
