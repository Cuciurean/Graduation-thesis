...
public class PostNewTrackableRequest8
{
    public string name;
    public float width;
    public string image;
...
public class CloudUpLoading8 : MonoBehaviour
{
    ...
    private string targetName = "P0007"; // must change when upload another Image Target, avoid same as exist Image on cloud
