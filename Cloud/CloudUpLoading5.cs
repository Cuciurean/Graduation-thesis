...
public class PostNewTrackableRequest5
{
    public string name;
    public float width;
    public string image;
...
public class CloudUpLoading5 : MonoBehaviour
{
    ...
    private string targetName = "P0004"; // must change when upload another Image Target, avoid same as exist Image on cloud
