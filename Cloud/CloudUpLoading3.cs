...
public class PostNewTrackableRequest3
{
    public string name;
    public float width;
    public string image;
...
public class CloudUpLoading3 : MonoBehaviour
{
    ...
    private string targetName = "P0002"; // must change when upload another Image Target, avoid same as exist Image on cloud
